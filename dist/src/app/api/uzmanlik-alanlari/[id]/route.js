...
function GET(req_1, _a) {
    return __awaiter(this, arguments, void 0, function (req, _b) {
        var session, id, uzmanlikAlani, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    uzmanlikAlani = _c.sent();
                    if (!uzmanlikAlani) {
                        return [2 /*return*/, new server_1.NextResponse(JSON.stringify({ error: "Uzmanlık alanı bulunamadı." }), { status: 404 })];
                    }
...
function PUT(req_1, _a) {
    return __awaiter(this, arguments, void 0, function (req, _b) {
        var session, id, body, ad, ekbilgi, existingUzmanlikAlani, duplicateUzmanlikAlani, updatedUzmanlikAlani, error_2;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 3:
                    existingUzmanlikAlani = _c.sent();
                    if (!existingUzmanlikAlani) {
                        return [2 /*return*/, new server_1.NextResponse(JSON.stringify({ error: "Uzmanlık alanı bulunamadı." }), { status: 404 })];
                    }
                    return [4 /*yield*/, prisma.uzmanlikAlani.findFirst({
                            where: {
                                ad: ad,
                                id: { not: id },
                            },
                ...
                case 4:
                    duplicateUzmanlikAlani = _c.sent();
                    ...
                    return [4 /*yield*/, prisma.uzmanlikAlani.update({
                            where: { id: id },
                            data: {
                                ad: ad,
                                ekbilgi: ekbilgi,
                ...
                case 5:
                    updatedUzmanlikAlani = _c.sent();
                    return [2 /*return*/, server_1.NextResponse.json(updatedUzmanlikAlani)];
                case 6:
                    error_2 = _c.sent();
                    console.error("API Error:", error_2);
                    return [2 /*return*/, new server_1.NextResponse(JSON.stringify({ error: "Uzmanlık alanı güncellenirken bir hata oluştu." }), { status: 500 })];
...
function DELETE(req_1, _a) {
    return __awaiter(this, arguments, void 0, function (req, _b) {
        var session, id, uzmanlikAlani, error_3;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.uzmanlikAlani.delete({
                            where: { id: id },
                        })];
                case 3:
                    // Uzmanlık alanını sil
                ...
                case 4:
                    ...
                    return [2 /*return*/, new server_1.NextResponse(JSON.stringify({ error: "Uzmanlık alanı silinirken bir hata oluştu." }), { status: 500 })];
